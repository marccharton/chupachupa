...
{
    public class RssItemCategoryParser : RssCategoryParser
    {
        ...
        public RssItemCategoryParser() : base() {
            String prefix = '/' + ROOT_NODE_NAME + '/' + CHANNEL_NODE_NAME + '/' + ITEM_NODE_NAME + '/' + CATEGORY_NODE_NAME;
